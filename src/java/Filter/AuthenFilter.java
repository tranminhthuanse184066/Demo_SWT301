...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        NON_AUTHEN_RESOURCE.add("SearchProductController");
        NON_AUTHEN_RESOURCE.add("order.jsp");
        NON_AUTHEN_RESOURCE.add("ViewOrderController");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (checkContain) {
                ...
                if (session == null || session.getAttribute("LOGIN_USER") == null && session.getAttribute("LOGIN_USER_GOOGLE") == null) {
